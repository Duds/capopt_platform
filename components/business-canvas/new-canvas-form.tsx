/**
 * New Canvas Form Component
 * 
 * Collects comprehensive business information for new canvas creation:
 * - Business identification and classification
 * - Industry and sector details
 * - Operational context and scope
 * - Strategic positioning
 * - Risk and compliance requirements
 * - All data stored in database for future modification
 */
...
interface NewCanvasFormProps {
  onCreateCanvas: (businessInfo: BusinessInformation) => void
  parentCanvasId?: string
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Create New Business Canvas
          </DialogTitle>
          <DialogDescription>
            Collect comprehensive business information to create a new canvas
          </DialogDescription>
        </DialogHeader>
